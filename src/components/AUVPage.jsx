...
const Specifications = () => {
  return (
    ...
    >
      ...
      <SpecItem title="Depth Rating" value="3000m" location="Maximum Operating Depth" />
      <SpecItem title="Endurance" value="8-12 hours" location="Battery Life" />
      <SpecItem title="Speed" value="2-4 knots" location="Cruising Speed" />
      <SpecItem title="Payload" value="15kg" location="Maximum Payload" />
      <SpecItem title="Sensors" value="Sonar, Camera, CTD" location="Standard Equipment" />
      <SpecItem title="Communication" value="Acoustic Modem" location="Underwater Link" />
      <SpecItem title="Navigation" value="INS + DVL" location="Positioning System" />
    </section>
  );
};

const SpecItem = ({ title, value, location }) => {
  return (
    <motion.div
      initial={{ y: 48, opacity: 0 }}
      whileInView={{ y: 0, opacity: 1 }}
    ...
    >
      <div>
        ...
        <p className="text-sm uppercase text-zinc-500">{value}</p>
      </div>
