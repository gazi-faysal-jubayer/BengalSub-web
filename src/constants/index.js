export const assets = {
  mobile: '/BengalSub-web/assets/mobile.png',
  backend: '/BengalSub-web/assets/backend.png',
  creator: '/BengalSub-web/assets/creator.png',
  web: '/BengalSub-web/assets/web.png',
  javascript: '/BengalSub-web/assets/tech/javascript.png',
  typescript: '/BengalSub-web/assets/tech/typescript.png',
  html: '/BengalSub-web/assets/tech/html.png',
  css: '/BengalSub-web/assets/tech/css.png',
  reactjs: '/BengalSub-web/assets/tech/reactjs.png',
  redux: '/BengalSub-web/assets/tech/redux.png',
  tailwind: '/BengalSub-web/assets/tech/tailwind.png',
  nodejs: '/BengalSub-web/assets/tech/nodejs.png',
  mongodb: '/BengalSub-web/assets/tech/mongodb.png',
  git: '/BengalSub-web/assets/tech/git.png',
  figma: '/BengalSub-web/assets/tech/figma.png',
  docker: '/BengalSub-web/assets/tech/docker.png',
  meta: '/BengalSub-web/assets/company/meta.png',
  starbucks: '/BengalSub-web/assets/company/starbucks.png',
  tesla: '/BengalSub-web/assets/company/tesla.png',
  shopify: '/BengalSub-web/assets/company/shopify.png',
  carrent: '/BengalSub-web/assets/carrent.png',
  jobit: '/BengalSub-web/assets/jobit.png',
  tripguide: '/BengalSub-web/assets/tripguide.png',
  threejs: '/BengalSub-web/assets/tech/threejs.svg',
  logo: '/BengalSub-web/assets/BengalSublogo.png',
};
